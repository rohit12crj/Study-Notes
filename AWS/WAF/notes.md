...
Q: Your SaaS application is only licensed for use in the US and Canada. How do you restrict access geographically?
A:
...
Q: You notice scrapers are harvesting product prices from your site, impacting performance. How do you handle this?
A:
...
Q: You have an allow rule for your office IP and a block rule for a country that includes your office IP's country. Users in the office are getting blocked. What's wrong?
A:
...
Q: After enabling AWS Managed Rules, some legitimate API requests from your mobile app are being blocked. How do you troubleshoot?
A:
...
Q: Your app runs in us-east-1 and eu-west-1 behind separate ALBs. How do you manage WAF consistently across both?
A:
...
Q: Your public REST API is being abused — attackers are fuzzing endpoints with malformed JSON payloads. How do you protect it?
A:
...
Q: Your WAF bill spiked due to high request volume. How do you optimize costs?
A:
...
Q: A critical zero-day vulnerability is disclosed for a framework your app uses. You need a temporary fix before patching. What do you do?
A:
